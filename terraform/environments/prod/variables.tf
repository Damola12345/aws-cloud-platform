...
variable "app_hostname" {
  description = "Full hostname to create and point at the ALB, e.g. finzla.dglidestcl.com. Must fall under domain_name (or its wildcard)."
  type        = string
  default     = "finzla.dglidestcl.com"
}
